...
namespace RMotownFestival.Api.Data
{
    static class FestivalDataSource
    {
        ...
        public static void Initialize(MotownDbContext context)
        {
            ...
            var stages = new List<Stage>() {
                         new Stage { Name = "Main Stage", Description = description },
                         new Stage { Name = "Orange Room", Description = description },
                         new Stage { Name = "StarDust", Description = description },
                         new Stage { Name = "Pink Room", Description = description }
            };
            ...
            Schedule lineUp = new Schedule();
            lineUp.Items.Add(new ScheduleItem { Artist = artists[0], Stage = stages[0], Time = new DateTime(1972, 07, 01, 20, 0, 0) });
            lineUp.Items.Add(new ScheduleItem { Artist = artists[4], Stage = stages[3], Time = new DateTime(1972, 07, 01, 20, 30, 0) });
            lineUp.Items.Add(new ScheduleItem { Artist = artists[2], Stage = stages[0], Time = new DateTime(1972, 07, 01, 22, 0, 0) });
            lineUp.Items.Add(new ScheduleItem { Artist = artists[1], Stage = stages[1], Time = new DateTime(1972, 07, 01, 22, 15, 0) });
            lineUp.Items.Add(new ScheduleItem { Artist = artists[0], Stage = stages[0], Time = new DateTime(1972, 07, 02, 20, 15, 0) });
            lineUp.Items.Add(new ScheduleItem { Artist = artists[4], Stage = stages[3], Time = new DateTime(1972, 07, 02, 20, 45, 0) });
            lineUp.Items.Add(new ScheduleItem { Artist = artists[3], Stage = stages[0], Time = new DateTime(1972, 07, 02, 22, 0, 0) });
            lineUp.Items.Add(new ScheduleItem { Artist = artists[1], Stage = stages[1], Time = new DateTime(1972, 07, 02, 22, 30, 0) });

            context.Schedules.Add(lineUp);
